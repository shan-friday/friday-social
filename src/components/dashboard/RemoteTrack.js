...
export class RemoteTrack extends React.Component {
    ...
    componentDidMount () {
        ...
        this.tracks = _.filter(window.friday.remoteTracks, (rt) => { return _.indexOf(trackIds, rt.id) !== -1 })
    ...
    componentDidUpdate (prevProps) {
        ...
        if (currentTrackIdText !== previousTrackIdText) {
            ...
            this.tracks = _.filter(window.friday.remoteTracks, { participantId: participantId })
            let videoTrack = _.find(this.tracks, { type: 'video' })
            let micTrack = _.find(this.tracks, { type: 'audio' })
            let newState = {}
            if (videoTrack) {
    ...
    render () {
        ...
        return <div className="flex justify-center">
            ...
            <div>
                <video autoPlay='1' ref={this.videoRef} width="100%"/>
            </div>
            <div>
